---
title: "Introduction to Statistical Modeling - Spring 2019"
author: ""
...
**Office Hours:** 1 p.m. - 1:50 p.m. T & R, 1 p.m. - 2:10 p.m. M & W, and by appointment
...
Tentative course assignments and due dates are maintained at: [https://StatisticalModeling.github.io/DataScience_2/CoursePacing/STT3531CoursePacingS2019.html](https://StatisticalModeling.github.io/DataScience_2/CoursePacing/STT3531CoursePacingS2019.html).
...
* There will be up to 5% (extra credit) for participation with [flipd](https://dashboard.flipdapp.co/).

      +  Download the free flipd app from [http://www.flipdapp.co/](http://www.flipdapp.co/)---do not purchase the premium upgrade on the App Store.
      
      +  Go to [https://dashboard.flipdapp.co/students/classaccess](https://dashboard.flipdapp.co/students/classaccess) and purchase access ($7.99)---Use your Appstate email.  I will write a promotional discount on the board which will lower the price to $3.99.  Additional details will be presented in class.
      
      + The five digit flipd class code: 47544
      
      + If you have issues with flipd, please inquire here: [https://intercom.help/flipdapp/for-students](https://intercom.help/flipdapp/for-students) 
