...
+ Complete and turn in a hard copy of your summary of "Inference for Numerical Data in R" using Quarto---Due Jan 25 NLT 5:00 PM 
  
+ [START LAB1: Questioning and Cleaning the bodyfat data Lab---Due Feb 1 NLT 5:00 PM]() 
...
+ [Complete LAB1: Questioning and Cleaning the bodyfat data Lab---Due Feb 1 NLT 5:00 PM]()        
...
+ Complete and turn in a hard copy of your summary of "Correlation and Regression" using Quarto---Due Feb 8 NLT 5:00 PM   
...
+ Misc Regression [topics](https://alanarnholt.github.io/STT3850/Rmarkdown/MiscRegression.html)
 ...
 + Complete and turn in a hard copy of your summary of "Modeling with Data in the Tidyverse" using Quarto---Due Feb 15 NLT 5:00 PM
...
+ Data set clean up due NLT 5:00 PM Feb 22 for Group Presentation # 1
...
+ Complete and turn in a hard copy of your summary of "Machine Learning with `caret` in R" using Quarto---Due Mar 7 NLT 5:00 PM 
...
+ [START LAB2: Linear models with the bodyfat data Lab---Due Mar 28 NLT 5:00 PM]() 
...
+ [Complete LAB2: Linear models with the bodyfat data Lab---Due Mar 28 NLT 5:00 PM]() 
...
+ Data set clean up due NLT 5:00 PM Mar 28 for Group Presentation # 2
...
+ [START LAB3: Non-linear models with the bodyfat data Lab---Due Apr 18 NLT 5:00 PM]() 
    
* * *

## Week 13: (Apr 16 -- 18) {-}

+ [Complete LAB3: Non-linear models with the bodyfat data Lab---Due Apr 18 NLT 5:00 PM]() 
...
+ Prepare **group** presentation.  Accept materials [here]() 
