...
The goal of this project is to create several different regression models and select the model that best predicts the response variable in a future data set the model has never seen.
