...
* Fit a basic linear regression model to your `car_train` data.  (Notice that we are fitting to `log_mpg` since the fuel efficiency had a log normal distribution.)
