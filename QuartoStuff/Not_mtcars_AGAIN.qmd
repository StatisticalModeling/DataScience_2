...
This majority of the material in this document is taken from the free online course at [https://supervised-ml-course.netlify.app/](https://supervised-ml-course.netlify.app/) written by Julia Silge.
:::
...
## Visulaize the fuel efficiency distribution
...
rf_wkfl <- workflow() |> 
  ...
  add_model(rf_spec)
set.seed(321)
rf_tune <- tune_grid(rf_wkfl, resample = car_folds, grid = 32)
rf_tune
```
